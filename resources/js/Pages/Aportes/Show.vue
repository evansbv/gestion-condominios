              ...
              <div v-if="aporte.monto_pagado > 0">
                <div class="border border-gray-200 rounded-lg p-4">
                  ...
                  <div v-if="aporte.comprobante" class="mt-2">
                    <a
                      :href="`/urbalemana/storage/${aporte.comprobante}`"
                      target="_blank"
                    ...
                    <img :src="`/urbalemana/storage/${aporte.comprobante}`" alt="Comprobante de Pago" class="mt-2 max-w-xs border rounded" v-if="aporte.comprobante.endsWith('.jpg') || aporte.comprobante.endsWith('.png')" />
