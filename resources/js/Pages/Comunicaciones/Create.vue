<template>
  <AppLayout title="Crear Comunicación">
    <div class="py-6">
      <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="mb-6">
          <h1 class="text-3xl font-bold text-gray-900">Nueva Comunicación</h1>
          <p class="mt-2 text-sm text-gray-600">Crear una nueva comunicación para enviar a los residentes</p>
        </div>
...
const submit = () => {
  ...
  form.post(route('comunicaciones.store'), {
    forceFormData: true
  })
}
